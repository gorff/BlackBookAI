...
#IMAGE_URL = 'https://tensorflow.org/images/blogs/serving/cat.jpg' #CAT
IMAGE_URL = 'https://cdn.pixabay.com/photo/2015/03/26/09/54/pug-690566_960_720.jpg' #PUG

def main():
  ## load in image classifications
  classification_dict = pd.load()
